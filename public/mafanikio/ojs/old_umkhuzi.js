...
const API = {
	async getIp(){ // api request to get IP and Landcode from user
		return fetch('https://api.ipdata.co/?api-key=3775757e3c0de0c23c1350373118630a3f6ccaa0fe51e9dbc5d716ba&fields=ip,country_code').then(res => res.json()).then((d)=>{
	    	return {
	    		sessionIp: d.ip, 
	    		sessionCountry: d.country_code,
